function [freqCenters, fftIndices] = get_fft_reference_selection(numBins, fs, chunkLength, minAnalysisFreq, maxAnalysisFreq, referenceMaxBins)
...
%   from a master grid defined by referenceMaxBins.
    ...
    binEdges = linspace(minAnalysisFreq, maxAnalysisFreq, referenceMaxBins + 1);
